    ...
    public void LancerPartie (int TailleLigne, int TailleColonne, int NombrePoints) {  //méthode qui permets de jouer à une partie classique. Dedans on détermine des nouvelles coordonnées de bouton à chaque fois qu'il est trouvé, et on affiche la nouvelle grille à chaque fois        
        ...
        while (cpt < NombrePoints) {  
            ...
            if ((Plateau.PresenceBouton2(ChoixLigne - 1,ChoixColonne - 1)!=Plateau.PresenceBouton(LigneON,ColonneON)) && (Plateau.PresenceBouton2(ChoixLigne-1, ChoixColonne-1)!=Plateau.PresenceMauvaisBouton(BadLigne,BadColonne))) {    //Premier essai. On vérifie que le bouton choisie n'est ni le bon ni le mauvais
                ...
                System.out.println("2e essai : Veuillez choisir la ligne du bouton allumé"); 
                ...
                if (( (Plateau.PresenceBouton2(ChoixLigne - 1,ChoixColonne - 1)!=Plateau.PresenceBouton(LigneON,ColonneON))) && (Plateau.PresenceBouton2(ChoixLigne-1, ChoixColonne-1)!=Plateau.PresenceMauvaisBouton(BadLigne,BadColonne))) {    //Deuxième essai, même fonctionnement que le premier, il gagne un point ou perds un point 
                    ...
                    System.out.println("3e essai : Veuillez choisir la ligne du bouton allumé"); 
                    ChoixLigne = scan.nextInt(); 
                    System.out.println("3e essai :Veuillez choisir la colonne du bouton allumé");  
                    ChoixColonne = scan.nextInt(); 
                    ...
                    } else if  (Plateau.PresenceBouton2(ChoixLigne - 1,ChoixColonne - 1)==Plateau.PresenceBouton(LigneON,ColonneON)) { //3e Essai, si on trouve le bon bouton ;
                        cpt+=1; //Si c'est la bonne case, l'utilisateur gagne un point
                        System.out.println("Troisieme essai : Vous avez finalement trouve le bon bouton");
                    ...
                    cpt+=1;
                    System.out.println("Deuxieme essai : Vous avez trouve le bon bouton");
                ...
                Plateau.DisparitionMauvaisBouton(BadLigne, BadColonne); 
                        ...
                        System.out.println("Vous êtes tombé dans le piège, vous perdez un point");
                        Plateau.DisparitionBouton(LigneON, ColonneON);
            }   else if ((Plateau.PresenceBouton2(ChoixLigne - 1,ChoixColonne - 1)==Plateau.PresenceBouton(LigneON, ColonneON)) && (Plateau.PresenceBouton2(ChoixLigne-1, ChoixColonne-1)==Plateau.PresenceMauvaisBouton(BadLigne,BadColonne))) {
                 cpt+=1;
                System.out.println("Vous avez trouve le bon bouton");
                Plateau.DisparitionBouton(LigneON, ColonneON);  
                Plateau.DisparitionMauvaisBouton(BadLigne, BadColonne);  
